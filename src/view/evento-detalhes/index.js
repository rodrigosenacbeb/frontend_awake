        ...
        <>
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <FacebookProvider appId="1562823380526484">
                    <Share href={urlCompartilhar}>
                        {({ handleClick, loading }) => (
                            <Link className="compartilhar-facebook" disabled="loading" onClick={handleClick}><i class="fab fa-facebook-f"></i> Compartilhar</Link>                            
                        )}
                    </Share>
                    </FacebookProvider>
